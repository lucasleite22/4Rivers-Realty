...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-dark flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-navy rounded-2xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-dark border border-white/10 rounded-lg px-4 py-2 text-white font-barlow focus:outline-none focus:border-cyan-brand"
            />
          </div>
          <div>
