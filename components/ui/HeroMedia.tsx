 ...
 * otherwise falls back to the static poster image — so the hero works
 * today and upgrades automatically once a real video file is dropped in.
 */
export default function HeroMedia({ videoSrc, posterSrc, alt }: Props) {
